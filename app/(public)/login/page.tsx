...
import InviteDetector from './invite-detector'
      ...
      <div className="relative w-full max-w-[400px] animate-fade-in">
        <div className="mb-10 flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            <h1 className="font-display text-[22px] font-semibold tracking-tight text-ink">iClose Admin</h1>
            <p className="mt-1 text-[13px] text-graphite">Sign in to your account</p>
          </div>
        </div>

        <div className="card-surface px-8 py-8">
          {/* InviteDetector checks for #access_token in URL client-side */}
          <InviteDetector />
        </div>
